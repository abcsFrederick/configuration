...
class Configuration(Resource):
    ...
    #     query = {
    #         'itemId': bson.objectid.ObjectId(overlayItemId),
    ...
    #     reference = json.dumps({'jobId': str(job['_id']), 'isCellCounting': True})

    #     overlayItem = Item().load(overlayItemId, user=user)

    #     outputs = {
    #         'elementsWithCell': utils.girderOutputSpec(overlayItem, token,
    #                                                    parentType='item',
    #                                                    name='annotationElement.json',
    #                                                    reference=reference)
